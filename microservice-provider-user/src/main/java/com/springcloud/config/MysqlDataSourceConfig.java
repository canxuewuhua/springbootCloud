...
@Configuration
@MapperScan(basePackages = "com.spring.cloud.**.mapper", sqlSessionFactoryRef="dataplatformSessionFactory")
@Slf4j
public class MysqlDataSourceConfig {
    ...
    public SqlSessionFactory sqlSessionFactory(@Qualifier("dataplatformDataSource") DataSource dataSource) throws Exception {
        ...
        hikariDataSource.setJdbcUrl("jdbc:mysql://localhost:3306/test?characterEncoding=utf-8&allowMultiQueries=true");
        hikariDataSource.setUsername("root");
        hikariDataSource.setPassword("123456");
        sessionFactoryBean.setDataSource(hikariDataSource);
        sessionFactoryBean.setMapperLocations(new PathMatchingResourcePatternResolver()
                .getResources("classpath*:com/spring/cloud/**/mapper/.**.*"));
